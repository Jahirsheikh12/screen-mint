      ...
      >
        ...
        {pixiReady && videoReady && (
          ...
          >
            <div
              ...
              className="absolute rounded-md border border-[#10B981]/80 bg-[#10B981]/20 shadow-[0_0_0_1px_rgba(16,185,129,0.35)]"
        ...
        <video
          ...
          onError={(e) => {
            ...
            console.error("Video load error:", { code, message: msg, src: videoEl.src });
            onError(`Failed to load video (error ${code}${msg ? `: ${msg}` : ""}). Source: ${videoEl.src}`);
          }}
        />
      </div>
    );
