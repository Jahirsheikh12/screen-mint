				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#10B981]/50 focus:ring-offset-2 focus:ring-offset-[#0A0F0D]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#10B981]/20 text-[#10B981]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#10B981]" />
						)}
					</button>
				);
			})}
