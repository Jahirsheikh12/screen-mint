...
export function ShortcutsConfigDialog() {
  ...
  return (
    <Dialog open={isConfigOpen} onOpenChange={(open: boolean) => { if (!open) handleClose(); }}>
      <DialogContent className="bg-[#0A0F0D] border-white/10 text-white max-w-[420px]">
        <DialogHeader>
                    ...
                    className={[
                      ...
                      isCapturing
                        ...
                        : hasConflict
                          ...
                          : 'bg-white/5 border-white/10 text-slate-200 hover:border-[#10B981]/50 hover:text-[#10B981] cursor-pointer',
                    ].join(' ')}
                  >
        ...
        <DialogFooter className="flex gap-2 sm:justify-between mt-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              size="sm"
              className="bg-[#10B981] hover:bg-[#1d4ed8] text-white"
              onClick={handleSave}
            >
